...
class CustomCNN(nn.Module):
    def __init__(self, num_classes):
        ...
        self.features = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=3, padding=1),  # block1
            nn.BatchNorm2d(64),
            ...
            nn.Conv2d(64, 128, kernel_size=3, padding=1),  # block2
            nn.BatchNorm2d(128),
            nn.ReLU(inplace=True),
            ...
            nn.Conv2d(128, 256, kernel_size=3, padding=1),  # block3
            nn.BatchNorm2d(256),
            nn.ReLU(inplace=True),
...
print(checkpoint.keys())  # model_state_dict, epoch 등 확인
